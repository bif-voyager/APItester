...
| `MAX_BULK_CONCURRENCY` | `1000` | Максимальное число одновременно выполняемых bulk-запросов |
| `MAX_BULK_CONNECTIONS` | `64` | Максимальное число TCP/TLS-соединений с одним целевым сервером |
