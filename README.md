...
Для проекта я добавил автоматические тесты frontend- и backend-логики. Сейчас набор включает 35 тестовых сценариев:

- 15 frontend-тестов для импорта cURL, разбора Swagger/OpenAPI и формирования стандартных HTTP-заголовков
- 20 backend-тестов для валидации запросов, параметров, заголовков, тела, таймаутов, редиректов, ограничения размера ответа, CORS, параллельного выполнения и API-обработчиков
